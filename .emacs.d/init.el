...
(custom-set-variables
 ...
 '(package-selected-packages
   '(diff-hl powerline doom-themes auto-compile org-bullets multi-term ob-elixir htmlize ox-twbs move-text web-mode use-package syntax-subword smartparens projectile oceanic-theme no-littering multiple-cursors magit flycheck flx expand-region exec-path-from-shell elixir-mode counsel))
