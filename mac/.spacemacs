...
you should place your code here."
  ...
  (org-babel-load-file (expand-file-name "package-settings.org" "~/personal/dotfiles/mac/.emacs.d/"))

  (org-babel-load-file (expand-file-name "org-configuration.org" "~/personal/dotfiles/mac/.emacs.d/"))

  (org-babel-load-file (expand-file-name "basic.org" "~/personal/dotfiles/mac/.emacs.d/"))
)
