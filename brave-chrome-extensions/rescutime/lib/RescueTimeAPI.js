...
var RescueTimeAPI = {
    ...
    authCookieName: 'remember_user_token',
    ...
    getIdentityParams: function() {
        ...
        params.os_username = this.engine.computer_name() + '-' + this.engine.identity;
    ...
    requestActivation: function(expects_account, uiCallback) {
        ...
        var activationCallback = function(data){
            ...
            params.os_username = [self.engine.computer_name(), app_identity].join('-');
    ...
    sendLogFile: function(logFile) {
        ...
        var storageCallback = function(data){
            ...
            params.os_username = self.engine.computer_name() + '-' + app_identity;
