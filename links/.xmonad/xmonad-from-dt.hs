...
myFont :: String
myFont = "IBM Plex Sans Cond SmBld:size=13:antialias=true:hinting=true"

myModMask :: KeyMask
myModMask = mod3Mask       -- Sets modkey to super/windows key

myTerminal :: String
myTerminal = "term"   -- Sets default terminal
...
myNormColor :: String
myNormColor   = "#424242"  -- Border color of normal windows

myFocusColor :: String
myFocusColor  = "#a89983"  -- Border color of focused windows
...
myManageHook = composeAll
     ...
     [ title =? "Brave"     --> doShift ( myWorkspaces !! 2 )
     ,title =? "Chrome"     --> doShift ( myWorkspaces !! 1 )
     ,title =? "Slack"     --> doShift ( myWorkspaces !! 3 )
...
myKeys home =
    ...
    -- Useful programs to have a keybinding for launch
        , ("M-S-<Return>", spawn (myTerminal ++ myShell))
    ...
    -- Workspaces
        ...
        -- , ("M-,", prevScreen)  -- Switch focus to prev monitorfloats
        -- , ("M-S-<KP_Add>", shiftTo Next nonNSP >> moveTo Next nonNSP)       -- Shifts focused window to next ws
        -- , ("M-S-<KP_Subtract>", shiftTo Prev nonNSP >> moveTo Prev nonNSP)  -- Shifts focused window to prev ws

    -- Floating windows
        , ("M-f", sendMessage (T.Toggle "floats")) -- Toggles my 'floats' layout
        , ("M-p", sendMessage (T.Toggle "monocle")) -- Toggles my 'floats' layout
        , ("M-g", sendMessage (T.Toggle "grid")) -- Toggles my 'floats' layout
        , ("M-t", withFocused $ windows . W.sink)  -- Push floating window back to tile
        , ("M-S-t", sinkAll)                       -- Push ALL floating windows to tile

    -- Increase/decrease spacing (gaps)
        , ("M-m", decWindowSpacing 4)           -- Decrease window spacing
        , ("M-n", incWindowSpacing 4)           -- Increase window spacing
        , ("M-S-m", decScreenSpacing 4)         -- Decrease screen spacing
        , ("M-S-n", incScreenSpacing 4)         -- Increase screen spacing
